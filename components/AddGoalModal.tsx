    ...
    >
      <div className="bg-white dark:bg-slate-800 rounded-xl shadow-2xl w-full max-w-md m-4">
        <div className="flex items-center justify-between p-5 border-b border-slate-200 dark:border-slate-700">
          <h2 className="text-lg font-semibold text-slate-800 dark:text-slate-200">Add a New Financial Goal</h2>
          <button 
            onClick={onClose} 
        ...
        <form onSubmit={handleSubmit}>
          <div className="p-6 space-y-4">
            <div>
              <label htmlFor="description" className="block text-sm font-medium text-slate-600 dark:text-slate-300 mb-1">Goal Description</label>
              <input
                type="text"
                id="description"
                value={description}
            ...
            <div>
              <label htmlFor="target" className="block text-sm font-medium text-slate-600 dark:text-slate-300 mb-1">Target Amount ({currency.code})</label>
            ...
            <div>
              <label htmlFor="deadline" className="block text-sm font-medium text-slate-600 dark:text-slate-300 mb-1">Deadline (Optional)</label>
              <input
                type="date"
                id="deadline"
                value={deadline}
